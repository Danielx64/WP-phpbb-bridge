...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'     				=> 'BRIDGE phpBB & WordPress', // The plugin name
			'slug'     				=> 'phpbb-wp-bridge', // The plugin slug (typically the folder name)
			'source'   				=> get_stylesheet_directory() . '\plugins\phpbb-wp-bridge.zip', // The plugin source
